...
import br.com.jardel.serialization.converter.YamlJackson2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    /**
     * Suporte a Negotiation formato YAML
     * @param converters
     */
    @Override
    ...
    /**
     * Suporte a Negotiation por onde receberá o content type
     * @param configurer
     */
    @Override
    public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {

        //Passando o formato por extensão
...
//                .mediaType("xml", MediaType.APPLICATION_XML);
        ...
        //Passando o formato por query param "mediaType"
...
//                .mediaType("xml", MediaType.APPLICATION_XML);
        ...
        //Passando o formato pelo header "Accept"
        configurer.favorPathExtension(false)
